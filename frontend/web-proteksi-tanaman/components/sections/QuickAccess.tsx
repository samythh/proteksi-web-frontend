    ...
    return (
        <section className="bg-[#749F74] py-12">
            <div className="container mx-auto px-4">
                ...
                <div className="bg-white max-w-5xl mx-auto rounded-xl shadow-2xl p-8 md:p-10">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
                        {QUICK_LINKS.map((item, index) => (
                            ...
                            >
                                {/* KOTAK IKON (BOX KECIL)
                  - Tanpa wrapper card di luarnya.
                  - Ukuran box dibuat besar (w-20 h-20 / w-24 h-24) agar dominan.
                  - Hover effect: Scale up sedikit.
                */}
                                <div className={`
